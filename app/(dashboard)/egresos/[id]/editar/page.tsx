...
export default function EditarEgresoPage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      setMontoClp(String(data.monto_clp ?? ""));
      setCategoria((data.categoria as EgresoCategoria) ?? "otro");
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="card space-y-3">
          ...
          <input
            ...
            placeholder="Ej: Insumos fotografía, Arriendo marzo..."
            required
          />
        </div>
        ...
        <div className="flex gap-3">
          ...
          <Link href={`/egresos/${id}`} className="btn-secondary">
            Cancelar
          </Link>
        </div>
      </form>
